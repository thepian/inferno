...
describe("old - MobX Provider", () => {
  ...
  describe("updating state", () => {
    ...
    it("should update a statefull component", () => {
      ...
      expect(container.innerHTML).toEqual(
        innerHTML(
          '<article><a id="update">update</a><span>Statefull</span></article>'
        )
      );
    });
    ...
    it("should update a stateless component", () => {
      ...
      expect(container.innerHTML).toEqual(
        innerHTML(
          '<article><a id="update">update</a><span>Stateless</span></article>'
        )
      );
    });
    ...
    it("should update a stateless component with stores", () => {
      ...
      expect(container.innerHTML).toEqual(
        innerHTML(
          '<article><a id="update">update</a><span>hello world</span></article>'
        )
      );
    });
  });
  ...
  describe("providing/updating stores", () => {
    ...
    it("should inherit stores from parent", () => {
      ...
      expect(container.innerHTML).toEqual(
        innerHTML("<div><span>one</span><span>two</span></div>")
      );
    });
  });
});
